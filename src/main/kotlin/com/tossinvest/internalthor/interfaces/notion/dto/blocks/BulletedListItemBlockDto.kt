...
open class BulletedListItemBlockDto
constructor(
    ...
    constructor(
        ...
        companion object {
            fun of(element: BulletedListItemBlock.Element): Element {
                return Element(
    ...
    companion object{
        fun of(block: Block): BlockDto {
            return BulletedListItemBlockDto(
                type = BlockType.of(block.type),
                id = block.id,
                hasChildren = block.hasChildren,
                bulletedListItem = Element.of(block.asBulletedListItem().bulletedListItem)
            )
        }
    }
}
